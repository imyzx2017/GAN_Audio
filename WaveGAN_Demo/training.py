...
import pprint
import pickle as pk
from sample_audio import get_all_audio_filepaths, create_data_split
...
def parse_arguments():
    ...
    parser.add_argument('-ld', '--latent-dim', dest='latent_dim', type=int, default=1000, help='Size of latent dimension used by generator')
